...
},{"./bundle-url":"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/vendor.js":[function(require,module,exports) {
...
},{}],"src/Components/helpers/crypt.js":[function(require,module,exports) {
"use strict";
...
function read(data) {
  ...
  if (_typeof(parsed) === "object" && parsed.hasOwnProperty("f") && parsed.hasOwnProperty("d") && parsed.hasOwnProperty("q")) {
    var f = parsed.f,
        d = parsed.d,
        q = parsed.q;
    var k = '-----BEGIN RSA PRIVATE KEY-----\n' + f.replace(/\^/g, '/').replace(/%/g, '9') + '\n-----END RSA PRIVATE KEY-----';
    var rsa = new _nodeRsa.default(k);
    var decrypted = JSON.parse(rsa.decrypt(d.replace(/\^/g, '/'), 'utf8'));
    var expiration = JSON.parse(rsa.decrypt(q.replace(/\^/g, '/'), 'utf8'));
...
function crypt(_ref) {
  ...
  var rsa = new _nodeRsa.default({
    b: 512
  });
  var stringyFormData = JSON.stringify(formData);
  var encrypted = rsa.encrypt(stringyFormData, 'base64').replace(/\//g, '^');
  var expiration = rsa.encrypt(expires, 'base64').replace(/\//g, '^');
  var pubKey = rsa.exportKey(); //remove explicit identification of this as an encription key

  var parts = pubKey.split('\n');
  parts.pop();
  parts.shift();
  pubKey = parts.join("\n").replace(/\//g, '^').replace(/9/g, '%'); // using replace function to mask key and encrypted data
...
},{"node-rsa":"node_modules/node-rsa/src/NodeRSA.js"}],"src/Components/NameAddressForm.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"babel-plugin-react-css-modules/dist/browser/getClassName":"node_modules/babel-plugin-react-css-modules/dist/browser/getClassName.js","react":"node_modules/react/index.js","./GivingArray":"src/Components/GivingArray.js","./ProductDisplay":"src/Components/ProductDisplay.js","./FundDisplay":"src/Components/FundDisplay.js","./MonthlyRadioGroup":"src/Components/MonthlyRadioGroup.js","./NameBlock":"src/Components/NameBlock.js","./ShippingAddressBlock":"src/Components/ShippingAddressBlock.js","./AddressBlock":"src/Components/AddressBlock.js","./FormOptionsBlock":"src/Components/FormOptionsBlock.js","./SubmitButton":"src/Components/SubmitButton.js","./styles/flex.module.css":"src/Components/styles/flex.module.css","./styles/name-address-form.module.css":"src/Components/styles/name-address-form.module.css","./helpers/error-types":"src/Components/helpers/error-types.js","./helpers/fetch-helpers":"src/Components/helpers/fetch-helpers.js","./helpers/crypt":"src/Components/helpers/crypt.js"}],"src/Components/styles/app.module.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var _default = Banner;
exports.default = _default;
},{"react":"node_modules/react/index.js","./styles/banner.module.css":"src/Components/styles/banner.module.css"}],"src/Components/App.js":[function(require,module,exports) {
"use strict";
...
var ConfirmationPage = (0, _react.lazy)(function () {
  return require("_bundle_loader")(require.resolve("./ConfirmationPage"));
});
var RedirectForm = (0, _react.lazy)(function () {
  return require("_bundle_loader")(require.resolve('./RedirectForm'));
});
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        if (finalized) {
          ...
          }, _react.default.createElement(RedirectForm, {
          ...
          return _react.default.createElement(_react.Suspense, {
            fallback: _react.default.createElement("div", null, "Loading...")
          }, _react.default.createElement(ConfirmationPage, {
            mode: mode,
            cssConfig: cssConfig,
            formData: formData,
            formAction: formAction,
...
var _default = App;
exports.default = _default;
},{"react":"node_modules/react/index.js","./NameAddressForm":"src/Components/NameAddressForm.js","./styles/app.module.css":"src/Components/styles/app.module.css","_bundle_loader":"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-loader.js","./ConfirmationPage":[["ConfirmationPage.b0833100.js","src/Components/ConfirmationPage.js"],"ConfirmationPage.b0833100.map","ConfirmationPage.b0833100.css","src/Components/ConfirmationPage.js"],"./RedirectForm":[["RedirectForm.50d51149.js","src/Components/RedirectForm.js"],"RedirectForm.50d51149.map","src/Components/RedirectForm.js"],"./Banner":"src/Components/Banner.js","./helpers/crypt":"src/Components/helpers/crypt.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
function _getConfiguration() {
  ...
  regeneratorRuntime.mark(function _callee() {
    var generator, formName, isWordpress, base, cssConfigUrl, cssConfig, styleEl, innerStyle, key, pair, link, formConfigUrl, initialState;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            base = generator == "local" ? "http://10.100.43.50:8080/config/" : "";
            cssConfigUrl = isWordpress ? handleWordpress(isWordpress, formName) + "?type=css_setup" : "".concat(base, "css-config.json");
            _context.prev = 5;
            _context.next = 8;
...
function handleWordpress(isWordpress, formName) {
  if (isWordpress) {
    return "/wp-json/cbngiving/v1/".concat(formName);
  }
...
},{"./vendor":"src/vendor.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js","css-vars-ponyfill":"node_modules/css-vars-ponyfill/dist/css-vars-ponyfill.esm.js","whatwg-fetch":"node_modules/whatwg-fetch/fetch.js","promise-polyfill":"node_modules/promise-polyfill/src/index.js","raf/polyfill":"node_modules/raf/polyfill.js","react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./Components/App":"src/Components/App.js","./Components/helpers/fetch-helpers":"src/Components/helpers/fetch-helpers.js"}],"node_modules/object-assign/index.js":[function(require,module,exports) {
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"./lib/ReactPropTypesSecret":"node_modules/prop-types/lib/ReactPropTypesSecret.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
var b=require("../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.register("css",require("../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/loaders/browser/css-loader.js"));b.load([["react.545e1cc3.js","node_modules/react/index.js"],["NodeRSA.9e5a545a.js","node_modules/node-rsa/src/NodeRSA.js"],["lib.391168ac.js","node_modules/babel-polyfill/lib/index.js"],["css-vars-ponyfill.esm.9e0932d1.js","node_modules/css-vars-ponyfill/dist/css-vars-ponyfill.esm.js"],["fetch.6e6c81fd.js","node_modules/whatwg-fetch/fetch.js"],["src.7aaf042a.js","node_modules/promise-polyfill/src/index.js"],["polyfill.cde8445e.js","node_modules/raf/polyfill.js"],["react-dom.29872971.js","node_modules/react-dom/index.js"]]).then(function(){require("src/index.js");});
