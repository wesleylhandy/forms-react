				...
				var a = function(l, a) {
						...
						if ("ccNumber" === l) {
							if (o.length > 4)
								switch (d[0]) {
									case "3":
										(c = (0, e.default)(d.slice(0, 4))),
											(u = [" "].concat((0, e.default)(d.slice(4, 10)))),
											(i =
												d.length > 10
													? [" "].concat((0, e.default)(d.slice(10, 15)))
													: []),
											(o = []
												.concat(
													(0, e.default)(c),
											...
											15 ==
												(s = s
													...
													.slice(0, 15)
													.join("")).length &&
												(f = (0, t.validateCCInput)("ccNumber", s, s).error);
										break;
									case "4":
									case "5":
									case "6":
									default:
										(c = (0, e.default)(d.slice(0, 4))),
											(u = [" "].concat((0, e.default)(d.slice(4, 8)))),
											(i =
												d.length > 8
													? [" "].concat((0, e.default)(d.slice(8, 12)))
													: []),
											(n =
												d.length > 12
													? [" "].concat((0, e.default)(d.slice(12, 16)))
													: []),
											(o = []
												.concat(
													(0, e.default)(c),
							...
							"phone" === l &&
								o.length > 0 &&
								((c = ["( "].concat((0, e.default)(d.slice(0, 3)), [" ) "])),
								(u = [].concat((0, e.default)(d.slice(3, 6)), [" - "])),
								(i = (0, e.default)(d.slice(6, 10))),
								(o = []
									.concat(
										(0, e.default)(c),
										(0, e.default)(u),
						...
						return {
							type: "UPDATE_FIELDS",
							fields: [
								{ name: l, value: s, error: f },
								{ name: r, value: o, error: "" },
							],
						};
					},
					c = a;
		...
		PiGv: [
			function(require, module, exports) {
				...
				var e = M(require("@babel/runtime/regenerator")),
					...
					v = require("../../helpers/cc-validation"),
					C = M(require("../FormComponents/FunctionalComponents/SubmitButton")),
					...
					w = M(require("../../helpers/form-display-values"));
				function E(e) {
					if (e && e.__esModule) return e;
					var t = {};
					if (null != e)
												...
												for (;;)
													switch ((e.prev = e.next)) {
														...
														case 9:
															return (
																(e.next = 11),
																i.context.submitGivingForm({ type: "testing" })
															);
														case 11:
															e.sent &&
																setTimeout(function() {
								...
								},
								{
									...
									value: function(e, t, r) {
										...
										if (r && !this.state.scrolled && this.context.selected)
											...
											var u = (0, v.checkValues)(n, i, l, s, d);
											if (u.passes) {
												var c = u.ccCardType;
									...
									value: function() {
										var e = this.context,
											...
											Z = Object.keys(J).map(function(e, t) {
												return (0,
												l.jsx)("input", { key: t + "-" + e, name: e, value: J[e] ? J[e] : "", type: "hidden" });
											}),
											Q =
				...
				_.contextType = c.GivingFormContext;
				var R = _;
				exports.default = R;
			},
			{
...
//# sourceMappingURL=/ConfirmationForm.1bbdc96f.js.map
