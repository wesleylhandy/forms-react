		...
		"+jVm": [
			function(require, module, exports) {
				...
				var e = require("@emotion/core"),
					t = r(require("react")),
					l = r(require("../ClubTab")),
					a = r(require("../StyledComponents/Divider")),
					n = r(require("../StyledComponents/FieldSet")),
					i = r(require("../StyledComponents/FormRow"));
				function r(e) {
					return e && e.__esModule ? e : { default: e };
				}
				var o = function(t) {
						var r = t.monthlyChecked,
							o = t.handleTabClick,
							s = r,
							d = !r;
						return (0, e.jsx)(
							...
							(0, e.jsx)(
								i.default,
								{
									...
									onKeyUp: function(e) {
										switch (e.keyCode) {
											case 35:
												e.preventDefault(), o({ target: { id: "singlegift" } });
												break;
											case 36:
												e.preventDefault(),
													o({ target: { id: "monthlygift" } });
												break;
											case 37:
											case 39:
												e.preventDefault(),
													o({
														target: { id: r ? "singlegift" : "monthlygift" },
													});
										}
									},
								},
								...
								(0, e.jsx)(a.default, { color: "transparent" }),
								(0, e.jsx)(l.default, {
									id: "single",
									name: "monthly-toggle",
									label: "Single Gift",
		...
		NcFV: [
			function(require, module, exports) {
				...
				var e = B(require("@babel/runtime/regenerator")),
					...
					x = B(require("../FormComponents/Seals")),
					b = B(require("../FormComponents/SubmitButton"));
				...
				var k = B(require("../FormComponents/Blocks/OtherGivingBlock")),
					...
					S = B(require("../FormComponents/Blocks/FooterBlock")),
					q = require("../../helpers/scrollToPoint");
				function F(e) {
					if (e && e.__esModule) return e;
					var t = {};
					if (null != e)
				...
				var O = (function(m) {
					function F() {
						...
						return (
							((i = (0, n.default)(
								this,
								(r = (0, l.default)(F)).call.apply(r, [this].concat(s))
							)).state = {
				...
				O.contextType = m.GivingFormContext;
				var P = O;
				exports.default = P;
			},
			{
...
//# sourceMappingURL=/AskForm.984adc42.js.map
