		...
		PiGv: [
			function(require, module, exports) {
				...
				var e = M(require("@babel/runtime/regenerator")),
					...
					s = M(require("@babel/runtime/helpers/inherits")),
					i = M(require("@emotion/styled-base")),
					l = require("@emotion/core"),
					d = w(require("react")),
							...
							return (
								...
								(s.handleMessage = function(e) {
									try {
										...
										if (
											...
											return;
										var d = e.origin;
										if (!s.context.msgUris.includes(d)) return;
										switch (r) {
											case "render receipt":
												clearTimeout(T),
								...
								(s.handleInputChange = function(e) {
									...
									if ("ccNumber" === o || "phone" === o) {
										...
										s.context.updateFields(n);
									} else
										s.context.updateField({
											type: "UPDATE_FIELD",
											name: o,
											value: r,
										});
												...
												for (;;)
													switch ((e.prev = e.next)) {
														case 0:
															...
															return (
																(e.next = 6),
																s.context.submitGivingForm({
																	type: "confirmation",
																})
															);
														case 6:
															e.sent && s.setState({ scrolled: !1 }),
																(e.next = 25);
															break;
														case 10:
															if (
															...
															break;
														case 15:
															return (c = "001"), e.abrupt("break", 23);
														case 17:
															return (c = "002"), e.abrupt("break", 23);
														case 19:
															return (c = "003"), e.abrupt("break", 23);
														case 21:
															return (c = "004"), e.abrupt("break", 23);
														case 23:
															(u = (0, C.checkValues)(c, a, l, i, d)).passes
																? setTimeout(function() {
																		return s.context.setConfirmed({
																			type: "CONFIRMED",
																			trackingVars: [
																				{
																					om_sMonthlyPledge: s.context.cart
																						.items[0].monthly
																						? "Y"
																						: "N",
																				},
								...
								},
								{
									...
									value: function() {
										var e = this.context,
											...
											n = e.selected,
											a = this.state,
											s = a.hiddenFormLoaded,
											i = a.hiddenFormSubmitted,
											l = a.scrolled,
											d =
												!(!o || !o.length) &&
								...
								},
								{
									...
									value: function(e, t, r) {
										...
										if (r && !this.state.scrolled && this.context.selected)
											...
											var c = (0, C.checkValues)(n, s, l, i, d);
											if (c.passes) {
												var u = c.ccCardType;
...
//# sourceMappingURL=/ConfirmationForm.6ca91a05.js.map
