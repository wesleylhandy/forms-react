parcelRequire = (function(e) {
	...
	var l = require("4vQ7").default("div", {
		target: "e19kc6t50",
		label: "RadioButton",
	})({
		name: "nyr9x",
	...
	function x(e) {
		...
		return require("haMh").jsx(
			...
			require("haMh").jsx(
				...
				require("haMh").jsx(f, { color: "transparent" }),
				require("haMh").jsx(d, {
					id: "single",
					name: "monthly-toggle",
					label: "one time gift",
	...
	require("4vQ7"), require("1n8/");
	var m = require("4vQ7").default("div", {
		target: "ea7p2am0",
		label: "TabGroup",
	})({
		name: "11ci7l4",
	...
	require("haMh"), require("1n8/"), require("T33x"), require("01J/");
	require("4vQ7"), require("1n8/");
	...
	require("4vQ7"), require("1n8/");
	var q = require("4vQ7").default("div", {
		target: "e16mrpwz0",
		label: "AmountError",
	})({
		name: "181ye5m",
					...
					value: function() {
						...
						return "buttons" === e
							? require("haMh").jsx(
									...
									require("haMh").jsx(q, { className: "amount-error" }, r),
									$ &&
										l &&
										require("haMh").jsx(z, {
											Monthlypledgeday: n,
	...
	w.contextType = require("zetz").GivingFormContext;
	require("1n8/");
	var B = function() {
		return null;
	};
			...
			return (
				...
				(o.updateProducts = function(e) {
					...
					var l = $Fhqp$$interop$default.d(o.state.cart.items),
						s = o.props.products[t],
						m = s.DetailName,
						$ = s.DetailCprojCredit,
						p = s.DetailCprojMail,
						u = s.DetailDescription,
						d = s.PledgeAmount,
				...
				(o.updateDonation = function(e) {
					var t = o.state.monthlyChecked,
						n = e.DetailName;
					(e.DetailName = t ? "MP".concat(n) : "SG".concat(n)),
						o.setState({ designationSelected: !0, designationInfo: e });
				}),
				o
			);
		}
	...
	e.contextType = require("zetz").GivingFormContext;
	var h = require("rUla").default(e);
	a.default = h;
