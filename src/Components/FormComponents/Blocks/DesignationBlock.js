...
const DesignationBlock = ({designations}) => {
    ...
    return (
        <DesignationContainer className="designation-container">
            <FormHeader role="label" id="listbox-label">Designate Gift (optional)</FormHeader>
            <Designation className="designation display" onClick={handleListFocus} aria-expanded={isOpen} aria-haspopup="listbox" aria-labelledby="listbox-label">
                <div className="designation__image">
                    <img className="img-responsive" src={designations[designatedIndex].img} alt={`The ministry of ${designations[designatedIndex].title}`}/>
                </div>
            ...
            <DesignationListContainer className="designation--list-container" hidden={!isOpen}>
