...
class ConfirmationPage extends Component {
	...
	shouldComponentUpdate(nextProps, nextState) {
		if (
			...
			this.state.confirmationSubmitted !== nextState.confirmationSubmitted
		) {
			return true;
		}
		return false;
	...
	render() {
		const { ready, confirmationSubmitted } = this.state;
		const { cssConfig, formAction, formData } = this.props;
