...
function (_Component) {
  ...
  function ConfirmationForm() {
    ...
    _this.handleMessage = function (e) {
      ...
      var types = ["payment form loaded", "form error", "render receipt"];
