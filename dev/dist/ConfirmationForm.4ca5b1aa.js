...
var InfoCircle = (0, _styledBase.default)("div", {
  ...
  name: "1dfxpn",
  styles: "position:absolute;right:5px;top:5px;a{cursor:pointer;text-decoration:none;color:#54585d;}"
} : {
  name: "1dfxpn",
  styles: "position:absolute;right:5px;top:5px;a{cursor:pointer;text-decoration:none;color:#54585d;}",
...
function (_Component) {
  ...
  (0, _createClass2.default)(ConfirmationForm, [{
    ...
    value: function getSnapshotBeforeUpdate() {
      ...
      var hasErrors = fields.errors && fields.errors.length ? Object.values(fields.errors).filter(function (val) {
