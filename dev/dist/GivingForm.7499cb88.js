...
parcelRequire = (function(modules, cache, entry, globalName) {
...
})(
	{
		...
		"src/Components/FormComponents/RadioButtonGroup.js": [
			function(require, module, exports) {
				"use strict";
				...
				(function() {
					...
					reactHotLoader.register(
						RadioButtonGroup,
						"RadioButtonGroup",
						"/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/RadioButtonGroup.js"
					);
					reactHotLoader.register(
						_default,
						"default",
		...
		"src/Components/FormComponents/Tab.js": [
			function(require, module, exports) {
				"use strict";
				...
				(function() {
					...
					reactHotLoader.register(
						Tab,
						"Tab",
						"/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Tab.js"
					);
					reactHotLoader.register(
						_default,
						"default",
		...
		"src/Components/FormComponents/Blocks/MonthlyTabBlock.js": [
			...
			},
			{
				...
				"react-hot-loader": "node_modules/react-hot-loader/index.js",
				react: "node_modules/react/index.js",
				"../Tab": "src/Components/FormComponents/Tab.js",
				...
				var AmountError = (0, _styledBase.default)("div", {
					...
					"development" === "production"
						? {
								name: "181ye5m",
								styles:
									"box-sizing:border-box;position:absolute;color:crimson;width:auto;left:50%;transform:translateX(-50%);bottom:auto;top:30px;font-weight:800;font-size:calc(19px * 0.5);opacity:1;overflow:hidden;max-width:100%;white-space:nowrap;",
						  }
						: {
								name: "181ye5m",
								styles:
		...
		"src/Components/Forms/GivingForm.js": [
			function(require, module, exports) {
				...
				var _withErrorBoundary = _interopRequireDefault(
					require("../withErrorBoundary")
				);
						...
						function GivingForm() {
							...
							_this.updateDonation = function(designationInfo) {
								...
								designationInfo.DetailName = monthlyChecked
									? "MP".concat(detailName)
									: "SG".concat(detailName); // console.log({designationInfo})
			...
			},
			{
				...
				"../Contexts/GivingFormProvider":
					"src/Components/Contexts/GivingFormProvider.js",
				"../withErrorBoundary": "src/Components/withErrorBoundary.js",
