			...
			function(require, module, exports) {
				...
				var n,
					...
					v = function(t, e) {
						...
						return (
							(r = e.roundToNearestHalfLine
								? Math.ceil((2 * o) / i) / 2
								: Math.ceil(o / i)) *
								i -
								o <
								2 * a && (r += e.roundToNearestHalfLine ? 0.5 : 1),
							r
						);
					},
					h = function(t) {
				...
				var it = function(t, e, r) {
						var n = t[e];
						(ot.call(t, e) && nt(n, r) && (void 0 !== r || e in t)) ||
							rt(t, e, r);
					},
					at = Array.isArray;
				var ut = function(t) {
				...
				var je = function(t) {
					...
					_e = {};
				(_e["[object Float32Array]"] = _e["[object Float64Array]"] = _e[
					"[object Int8Array]"
				] = _e["[object Int16Array]"] = _e["[object Int32Array]"] = _e[
					"[object Uint8Array]"
				] = _e["[object Uint8ClampedArray]"] = _e["[object Uint16Array]"] = _e[
					"[object Uint32Array]"
				] = !0),
					(_e["[object Arguments]"] = _e["[object Array]"] = _e[
						"[object ArrayBuffer]"
					] = _e["[object Boolean]"] = _e["[object DataView]"] = _e[
						"[object Date]"
					] = _e["[object Error]"] = _e["[object Function]"] = _e[
						"[object Map]"
					] = _e["[object Number]"] = _e["[object Object]"] = _e[
						"[object RegExp]"
					] = _e["[object Set]"] = _e["[object String]"] = _e[
						"[object WeakMap]"
					] = !1);
				var we = function(t) {
				...
				var fn = function(t, e, r, n, o, i, a) {
					switch (r) {
						...
						case an:
							return !(
								t.byteLength != e.byteLength || !i(new tr(t), new tr(e))
							);
						case Kr:
						case Yr:
						case tn:
						...
						d =
							...
							f(a.baseLineHeight)
								...
								: (a.baseLineHeightInPx =
										s(a.baseFontSize) * a.baseLineHeight + "px"),
							{
								rhythm: h(a),
								...
								adjustFontSizeTo: function(t, e, r) {
									return (
										...
										(function(t, e, r, n) {
											...
											return (
												"auto" === e && (e = v(t, n)),
												{ fontSize: o(t, n.rhythmUnit, r), lineHeight: i(e, r) }
											);
										})(t, e, r, a)
									);
								},
...
//# sourceMappingURL=/dist.a16385fa.js.map
