...
parcelRequire = (function(modules, cache, entry, globalName) {
	...
	{
		"node_modules/react-aria-live/es/modules/MessageBlock.js": [
		...
		"node_modules/react-aria-live/es/modules/Announcer.js": [
			function(require, module, exports) {
				"use strict";
				...
				var Announcer = (function(_Component) {
					...
					Announcer.getDerivedStateFromProps = function getDerivedStateFromProps(
						nextProps,
						state
					) {
						...
						if (
							...
							return {
								assertiveMessage1: state.setAlternateAssertive
									? ""
									: assertiveMessage,
								assertiveMessage2: state.setAlternateAssertive
									? assertiveMessage
									: "",
								oldAssertiveMessage: assertiveMessage,
								oldAssertiveMessageId: assertiveMessageId,
		...
		"node_modules/react-aria-live/es/modules/AnnouncerContext.js": [
			function(require, module, exports) {
				"use strict";
		...
		"node_modules/react-aria-live/es/modules/LiveAnnouncer.js": [
			function(require, module, exports) {
				"use strict";
				...
				var _AnnouncerContext = _interopRequireDefault(
					require("./AnnouncerContext")
				);
				...
				var LiveAnnouncer = (function(_Component) {
					...
					LiveAnnouncer.prototype.render = function render() {
						...
						return _react.default.createElement(
							_AnnouncerContext.default.Provider,
							{
								value: updateFunctions,
							},
							this.props.children,
							_react.default.createElement(_Announcer.default, {
			...
			{
				react: "node_modules/react/index.js",
				"./Announcer": "node_modules/react-aria-live/es/modules/Announcer.js",
				"./AnnouncerContext":
					"node_modules/react-aria-live/es/modules/AnnouncerContext.js",
			},
		],
		...
		"node_modules/react-aria-live/es/modules/AnnouncerMessage.js": [
			function(require, module, exports) {
				"use strict";
				...
				var AnnouncerMessage = (function(_Component) {
					...
					AnnouncerMessage.prototype.componentDidUpdate = function componentDidUpdate(
						prevProps
					) {
				...
				AnnouncerMessage.propTypes =
					"development" !== "production"
						? {
								message: _propTypes.default.string.isRequired,
								"aria-live": _propTypes.default.string.isRequired,
								clearOnUnmount: _propTypes.default.oneOfType([
									_propTypes.default.bool,
									_propTypes.default.oneOf(["true", "false"]),
								]),
		...
		"node_modules/react-aria-live/es/modules/LiveMessage.js": [
			function(require, module, exports) {
				"use strict";
				...
				var _AnnouncerMessage = _interopRequireDefault(
					require("./AnnouncerMessage")
				);
				...
				var LiveMessage = function LiveMessage(props) {
					return _react.default.createElement(
						_AnnouncerContext.default.Consumer,
						null,
						function(contextProps) {
							return _react.default.createElement(
								_AnnouncerMessage.default,
								_extends({}, contextProps, props)
							);
						}
					);
				};
		...
		"node_modules/react-aria-live/es/modules/LiveMessenger.js": [
			function(require, module, exports) {
				"use strict";
		...
		"node_modules/react-aria-live/es/index.js": [
			function(require, module, exports) {
				...
				var _LiveAnnouncer2 = _interopRequireDefault(
					require("./modules/LiveAnnouncer")
				);

				var _LiveMessage2 = _interopRequireDefault(
					require("./modules/LiveMessage")
				);

				var _LiveMessenger2 = _interopRequireDefault(
					require("./modules/LiveMessenger")
				);
			...
			{
				"./modules/LiveAnnouncer":
					"node_modules/react-aria-live/es/modules/LiveAnnouncer.js",
				"./modules/LiveMessage":
					"node_modules/react-aria-live/es/modules/LiveMessage.js",
				"./modules/LiveMessenger":
					"node_modules/react-aria-live/es/modules/LiveMessenger.js",
			},
		],
