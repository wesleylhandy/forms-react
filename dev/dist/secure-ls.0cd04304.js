									...
									_createClass(SecureLS, [
										{
											...
											value: function init() {
												...
												this.utils.allKeys =
													metaData.keys || this.resetAllKeys();
											},
										},
										{
										...
										},
										{
											...
											value: function getEncryptionSecret(key) {
												var metaData = this.getMetaData();
												var obj = this.utils.getObjectFromKey(
													metaData.keys,
													key
												);
										...
										},
										{
											...
											value: function get(key, isAllKeysData) {
												...
												if (this._isBase64 || isAllKeysData) {
													...
													if (bytes) {
														decodedData = bytes.toString(
															_encUtf2.default._Utf8
														);
													}
												}
							...
							/***/ function(module, exports, __webpack_require__) {
								...
								var utils = {
									...
									generateSecretKey: function generateSecretKey() {
										...
										var key128Bits = (0, _pbkdf2.default)(
											this.secretPhrase,
											salt,
											{ keySize: 128 / 32 }
										);
								...
								var LZString = (function() {
									...
									var LZString = {
										...
										decompressFromBase64: function(input) {
											...
											return LZString._decompress(input.length, 32, function(
												index
											) {
...
//# sourceMappingURL=/secure-ls.0cd04304.js.map
