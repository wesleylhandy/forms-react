...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/@babel/runtime/helpers/inheritsLoose.js":[function(require,module,exports) {
...
},{"react-is":"node_modules/react-is/index.js","./factoryWithTypeCheckers":"node_modules/prop-types/factoryWithTypeCheckers.js"}],"src/vendors.js":[function(require,module,exports) {
...
},{}],"src/helpers/ls.js":[function(require,module,exports) {
"use strict";
...
},{"secure-ls":"node_modules/secure-ls/dist/secure-ls.js"}],"src/helpers/fetch-helpers.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log(useIntercept ? "Requesting permission for flyby." : "That's a negative Ghostrider, the pattern is full.");
...
},{"@babel/runtime/regenerator":"node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"node_modules/@babel/runtime/helpers/asyncToGenerator.js","whatwg-fetch":"node_modules/whatwg-fetch/fetch.js","./ls":"src/helpers/ls.js"}],"node_modules/@babel/runtime/helpers/classCallCheck.js":[function(require,module,exports) {
...
},{"./setPrototypeOf":"node_modules/@babel/runtime/helpers/setPrototypeOf.js"}],"node_modules/@babel/runtime/helpers/arrayWithHoles.js":[function(require,module,exports) {
...
},{}],"src/helpers/get-query-variable.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  reactHotLoader.register(getQueryVariable, "getQueryVariable", "/Users/wehand/Code/react-form-drupal/src/helpers/get-query-variable.js");
})();
...
},{}],"src/Components/Contexts/FormConfigProvider.js":[function(require,module,exports) {
"use strict";
...
var _getQueryVariable = _interopRequireDefault(require("../../helpers/get-query-variable"));
...
function (_Component) {
  ...
  function FormConfigProvider() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(FormConfigProvider)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      idleWarning: -1,
      expiredWarning: -1,
      expired: false,
      ...
      getConfiguration: function () {
        ...
        _regenerator.default.mark(function _callee(_ref) {
          var rootEntry, formType, initialState, initialStyle, cssConfig, formConfig, tokenRefreshUri, generator, formName, proxyUri, isLocal, isDrupal, isWordpress, queryPreset, preset, headerTitle, headerSubtitle, submitButtonText, configUrl, config, _ref2, _ref3, configurations, _formConfig, _formConfig$designati, designations, idx, presetTitle;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  initialState = {}, initialStyle = {}, cssConfig = {}, formConfig = {}, tokenRefreshUri = "";
                  _context.prev = 2;
                  ...
                  isLocal = generator && generator.includes("local");
                  isDrupal = generator && generator.includes("drupal");
                  isWordpress = generator && generator.includes("wordpress");
                  queryPreset = (0, _getQueryVariable.default)("preset");
                  preset = queryPreset ? queryPreset : rootEntry.dataset.preset;
                  headerTitle = rootEntry.dataset.title;
                  headerSubtitle = rootEntry.dataset.subtitle;
                  submitButtonText = rootEntry.dataset.submitButtonText;
                ...
                case 19:
                  ...
                  configUrl = "".concat(proxyUri, "cbngiving/v1/").concat(formName, "?type=initial_setup");
                  tokenRefreshUri = "".concat(proxyUri, "cbngiving/v1/refresh_token?campaign=").concat(formName);
                  _context.next = 24;
                ...
                case 24:
                  ...
                  if (initialState.formType === "signup") {
                    proxyUri += "/contacts/".concat(initialState.contactAPI.type);
                  }
                ...
                case 31:
                  proxyUri = "http://".concat("127.0.0.1", ":").concat("8282");
                  _context.next = 34;
                  return Promise.all([(0, _fetchHelpers.callApi)("".concat(proxyUri, "/config/form-config.json"), {
                    method: "GET"
                  }, true), (0, _fetchHelpers.callApi)("".concat(proxyUri, "/config/css-config.json"), {
                    method: "GET"
                  }, true)]);
                ...
                case 38:
                  ...
                  cssConfig = Array.isArray(configurations) ? configurations.filter(function (config) {
                    return config.formType == formType;
                  })[0].cssConfig : initialStyle; // Disable React Dev Tools in Production
                  ...
                  formConfig.tokenRefreshUri = isLocal ? "".concat(proxyUri, "/refresh?campaign=").concat(formName) : tokenRefreshUri;

                  _this.setTimeouts();

                  if (preset) {
                    _formConfig = formConfig, _formConfig$designati = _formConfig.designations, designations = _formConfig$designati === void 0 ? [{
                      DetailName: ""
                    }] : _formConfig$designati;
                    ...
                    if (idx > -1) {
                      ...
                      presetTitle = idx > -1 ? designations[idx].title : "";

                      if (presetTitle && headerTitle) {
                        formConfig.formHeader.title = headerTitle.replace(/(\#\#PRESET\#\#)/gi, presetTitle);
                      }

                      if (presetTitle && headerSubtitle) {
                        formConfig.formHeader.description = headerSubtitle.replace(/(\#\#PRESET\#\#)/gi, presetTitle);
                      }
                    }
                  } else {
                    if (headerTitle) {
                      formConfig.formHeader.title = headerTitle.replace(/(\#\#PRESET\#\#)/gi, "CBN Ministries");
                    }

                    if (headerSubtitle) {
                      formConfig.formHeader.description = headerSubtitle.replace(/(\#\#PRESET\#\#)/gi, "CBN Ministries");
                    }
                  }
      ...
      getCssConfig: function getCssConfig(type) {
        var config = Object.entries(_this.state.cssConfig).reduce(function (obj, _ref5) {
    ...
    _regenerator.default.mark(function _callee2() {
      ...
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              if (!(_this.state.idleWarning != -1)) {
                _context2.next = 10;
                break;
              }

              _context2.prev = 1;
              res = (0, _fetchHelpers.callApi)(_this.state.formConfig.tokenRefreshUri, {
                method: "GET"
              }, true);
            ...
            case 10:
              idleWarning = setTimeout(function () {
                return alert("This session will expire in 5 minutes.");
              }, 25 * 60 * 1000);
              expiredWarning = setTimeout(function () {
                return _this.setState({
                  expired: true
                }, function () {
                  return alert("This session has expired. Please refresh this page if you wish to continue.");
                });
              }, 30 * 60 * 1000);
  ...
  (0, _createClass2.default)(FormConfigProvider, [{
    ...
    value: function render() {
      ...
      return (0, _core.jsx)(FormConfigContext.Provider, {
        value: state
      }, children);
    }
  }, {
...
},{"@babel/runtime/regenerator":"node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/slicedToArray":"node_modules/@babel/runtime/helpers/slicedToArray.js","@babel/runtime/helpers/asyncToGenerator":"node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","@babel/runtime/helpers/possibleConstructorReturn":"node_modules/@babel/runtime/helpers/possibleConstructorReturn.js","@babel/runtime/helpers/getPrototypeOf":"node_modules/@babel/runtime/helpers/getPrototypeOf.js","@babel/runtime/helpers/inherits":"node_modules/@babel/runtime/helpers/inherits.js","@babel/runtime/helpers/defineProperty":"node_modules/@babel/runtime/helpers/defineProperty.js","react":"node_modules/react/index.js","../../helpers/fetch-helpers":"src/helpers/fetch-helpers.js","../../helpers/get-query-variable":"src/helpers/get-query-variable.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"node_modules/@babel/runtime/helpers/extends.js":[function(require,module,exports) {
function _extends() {
...
(function () {
  ...
  reactHotLoader.register(formErrors, "formErrors", "/Users/wehand/Code/react-form-drupal/src/helpers/error-types.js");
  reactHotLoader.register(breakingErrors, "breakingErrors", "/Users/wehand/Code/react-form-drupal/src/helpers/error-types.js");
  reactHotLoader.register(getErrorType, "getErrorType", "/Users/wehand/Code/react-form-drupal/src/helpers/error-types.js");
})();
...
},{}],"src/helpers/cc-validation.js":[function(require,module,exports) {
"use strict";
...
var IsValidCreditCardType = function IsValidCreditCardType(cardNum, cardType) {
  var prefix = 0;
  ...
  switch (cardType) {
    ...
    case "004":
      ...
      if ((prefix < 60110000 || prefix > 60119999) && (prefix < 65000000 || prefix > 65999999) && (prefix < 62212600 || prefix > 62292599)) {
        return false;
      }
...
var validateCCInfo = function validateCCInfo(curccnum, curccType, curccExpYear, curccExpMonth, curcvnCode) {
  var passes = true,
      errors = [];
...
var checkValues = function checkValues(ccCardType, ccNum, ccExpMonth, ccExpYear, cvnCode) {
  var ccExpDate = ccExpMonth + "-" + ccExpYear; // initialize variables

  var transactionType = null,
      signatureDis = false;
  var isValid = validateCCInfo(ccNum, ccCardType, ccExpYear, ccExpMonth, cvnCode);
...
(function () {
  ...
  reactHotLoader.register(checkExpDate, "checkExpDate", "/Users/wehand/Code/react-form-drupal/src/helpers/cc-validation.js");
  reactHotLoader.register(checkDigits, "checkDigits", "/Users/wehand/Code/react-form-drupal/src/helpers/cc-validation.js");
  reactHotLoader.register(validateCCInput, "validateCCInput", "/Users/wehand/Code/react-form-drupal/src/helpers/cc-validation.js");
  reactHotLoader.register(IsValidCreditCardType, "IsValidCreditCardType", "/Users/wehand/Code/react-form-drupal/src/helpers/cc-validation.js");
  reactHotLoader.register(validateCCInfo, "validateCCInfo", "/Users/wehand/Code/react-form-drupal/src/helpers/cc-validation.js");
  reactHotLoader.register(checkValues, "checkValues", "/Users/wehand/Code/react-form-drupal/src/helpers/cc-validation.js");
  reactHotLoader.register(checkCVNCode, "checkCVNCode", "/Users/wehand/Code/react-form-drupal/src/helpers/cc-validation.js");
})();
...
},{}],"src/helpers/validators.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime/regenerator":"node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"node_modules/@babel/runtime/helpers/asyncToGenerator.js","./fetch-helpers":"src/helpers/fetch-helpers.js","./cc-validation":"src/helpers/cc-validation.js"}],"src/helpers/reducer.js":[function(require,module,exports) {
"use strict";
    ...
    case "UPDATE_GIVING_TYPE":
      ...
      if (found > -1) {
        items[found] = {
          ...
          DetailCprojMail: typeId == "singlegift" ? singlePledgeData.DetailCprojMail : monthlyPledgeData.DetailCprojMail,
          DetailCprojCredit: typeId == "singlegift" ? singlePledgeData.DetailCprojCredit : monthlyPledgeData.DetailCprojCredit,
          DetailDescription: typeId == "singlegift" ? singlePledgeData.DetailDescription : monthlyPledgeData.DetailDescription,
          DetailName: typeId == "singlegift" ? singlePledgeData.DetailName : monthlyPledgeData.DetailName,
...
},{"@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/helpers/defineProperty":"node_modules/@babel/runtime/helpers/defineProperty.js"}],"src/Components/Contexts/GivingFormProvider.js":[function(require,module,exports) {
"use strict";
...
function (_Component) {
    ...
    _this.state = {
      ...
      loadLS: function loadLS(action) {
        ...
        if (data) {
          var items = data.items,
              formData = (0, _objectWithoutProperties2.default)(data, ["items"]);
      ...
      saveLS: function () {
        ...
        _regenerator.default.mark(function _callee(lifetime, type) {
          var _this$state$fields, Address1, Address2, City, Country, Emailaddress, Firstname, Middlename, Lastname, Spousename, Suffix, State, Title, Zip, phone, Phoneareacode, Phoneexchange, Phonenumber, formData, monthlychecked, items, pledgeFound;

          return _regenerator.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _this$state$fields = _this.state.fields, Address1 = _this$state$fields.Address1, Address2 = _this$state$fields.Address2, City = _this$state$fields.City, Country = _this$state$fields.Country, Emailaddress = _this$state$fields.Emailaddress, Firstname = _this$state$fields.Firstname, Middlename = _this$state$fields.Middlename, Lastname = _this$state$fields.Lastname, Spousename = _this$state$fields.Spousename, Suffix = _this$state$fields.Suffix, State = _this$state$fields.State, Title = _this$state$fields.Title, Zip = _this$state$fields.Zip, phone = _this$state$fields.phone;
                  Phoneareacode = phone && phone.trim().match(_validators.phone_regex) ? phone.trim().match(_validators.phone_regex)[1] : "", Phoneexchange = phone && phone.trim().match(_validators.phone_regex) ? phone.trim().match(_validators.phone_regex)[2] : "", Phonenumber = phone && phone.trim().match(_validators.phone_regex) ? phone.trim().match(_validators.phone_regex)[3] : "";
                  formData = {
                    Address1: Address1,
                    Address2: Address2,
                    City: City,
                ...
                case 0:
                  return _context6.abrupt("return", new Promise(function (resolve, reject) {
                    ...
                    _regenerator.default.mark(function _callee5() {
                        ...
                        while (1) {
                          switch (_context5.prev = _context5.next) {
                            ...
                            case 66:
                              ...
                              Phoneareacode = phone.trim().match(_validators.phone_regex) ? phone.trim().match(_validators.phone_regex)[1] : "", Phoneexchange = phone.trim().match(_validators.phone_regex) ? phone.trim().match(_validators.phone_regex)[2] : "", Phonenumber = phone.trim().match(_validators.phone_regex) ? phone.trim().match(_validators.phone_regex)[3] : ""; //process cart
                            ...
                            case 99:
                              _context5.prev = 99;
                              _context5.t4 = _context5["catch"](88);
                      ...
                      }, _callee5, null, [[6, 52], [14, 20], [25, 34], [39, 45], [88, 99]]);
                    })));
                  }));
          ...
          _this.setState(function (state) {
            ...
            _this.setState(function (state) {
              ...
              if (!isValidGift) {
                ...
                try {
                  _this.context.refreshToken();

                  var url = window.location.origin + window.location.pathname;
                  var sDynamicPageUrl = url + (url.charAt(url.length - 1) == "/" ? "payment" : "/payment");
                  var sDynamicPageTitle = document.title + " > Choose Donation";
                  window.omTrackDynamicCBNPage(sDynamicPageUrl, sDynamicPageTitle);
                } catch (err) {
                  console.error("Call Submission Tracking Error");
                  console.error(err);
      ...
      getSelection: function getSelection(action) {
        return _this.setState(function (state) {
          ...
          return _this.context.refreshToken();
        });
      },
      goBack: function goBack(action) {
        return _this.setState(function (state) {
      ...
      getSummary: function getSummary() {
        ...
        var amount = pledgeFound > -1 ? items[pledgeFound].PledgeAmount : 0;
        var designation = Object.keys(_this.state.designationInfo).length && !(isMonthly && !_this.state.allowMonthlyDesignations) ? _this.state.designationInfo.title : "Where Most Needed";
        return {
          amount: amount,
          isMonthly: isMonthly,
  ...
  (0, _createClass2.default)(GivingFormProvider, [{
    ...
    value: function render() {
      var state = this.state,
          children = this.props.children;
      return (0, _core.jsx)(GivingFormContext.Provider, {
        value: state
      }, children);
    }
  }, {
...
(function () {
  ...
  reactHotLoader.register(d, "d", "/Users/wehand/Code/react-form-drupal/src/Components/Contexts/GivingFormProvider.js");
  reactHotLoader.register(curMonth, "curMonth", "/Users/wehand/Code/react-form-drupal/src/Components/Contexts/GivingFormProvider.js");
  reactHotLoader.register(curYear, "curYear", "/Users/wehand/Code/react-form-drupal/src/Components/Contexts/GivingFormProvider.js");
...
},{"@babel/runtime/regenerator":"node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/helpers/asyncToGenerator":"node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/helpers/objectWithoutProperties":"node_modules/@babel/runtime/helpers/objectWithoutProperties.js","@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","@babel/runtime/helpers/possibleConstructorReturn":"node_modules/@babel/runtime/helpers/possibleConstructorReturn.js","@babel/runtime/helpers/getPrototypeOf":"node_modules/@babel/runtime/helpers/getPrototypeOf.js","@babel/runtime/helpers/inherits":"node_modules/@babel/runtime/helpers/inherits.js","react":"node_modules/react/index.js","./FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","../../helpers/ls":"src/helpers/ls.js","../../helpers/error-types":"src/helpers/error-types.js","../../helpers/fetch-helpers":"src/helpers/fetch-helpers.js","../../helpers/validators":"src/helpers/validators.js","../../helpers/reducer":"src/helpers/reducer.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/Contexts/ProductFormProvider.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime/regenerator":"node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","@babel/runtime/helpers/possibleConstructorReturn":"node_modules/@babel/runtime/helpers/possibleConstructorReturn.js","@babel/runtime/helpers/getPrototypeOf":"node_modules/@babel/runtime/helpers/getPrototypeOf.js","@babel/runtime/helpers/inherits":"node_modules/@babel/runtime/helpers/inherits.js","react":"node_modules/react/index.js","./FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","../../helpers/ls":"src/helpers/ls.js","../../helpers/error-types":"src/helpers/error-types.js","../../helpers/fetch-helpers":"src/helpers/fetch-helpers.js","../../helpers/validators":"src/helpers/validators.js","../../helpers/reducer":"src/helpers/reducer.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/Contexts/SignUpFormProvider.js":[function(require,module,exports) {
"use strict";
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          ...
                          case 33:
                            ...
                            contactAPI = _objectSpread({}, _this.context.formConfig.contactAPI);
                            ...
                            if (contactAPI.type = "feedback") {
                              ...
                              contactAPI.headers.FormUrl = window.location.origin + window.location.pathname + window.location.search;
                              contactAPI.headers.Message = message ? message : "--Empty--";
                            } else if (contactAPI.type = "activity") {
                              contactAPI.headers.Location = window.location.origin + window.location.pathname;
                              contactAPI.headers.Campaign = contactAPI.headers.Campaign || motivation;
                              contactAPI.headers.EmailAddress = Emailaddress;
                              contactAPI.headers.FirstName = Firstname;
                              contactAPI.headers.LastName = Lastname;
...
},{"@babel/runtime/helpers/defineProperty":"node_modules/@babel/runtime/helpers/defineProperty.js","@babel/runtime/regenerator":"node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","@babel/runtime/helpers/possibleConstructorReturn":"node_modules/@babel/runtime/helpers/possibleConstructorReturn.js","@babel/runtime/helpers/getPrototypeOf":"node_modules/@babel/runtime/helpers/getPrototypeOf.js","@babel/runtime/helpers/inherits":"node_modules/@babel/runtime/helpers/inherits.js","react":"node_modules/react/index.js","./FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","../../helpers/fetch-helpers":"src/helpers/fetch-helpers.js","../../helpers/validators":"src/helpers/validators.js","../../helpers/reducer":"src/helpers/reducer.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"node_modules/@emotion/is-prop-valid/dist/is-prop-valid.browser.esm.js":[function(require,module,exports) {
"use strict";
...
var _default = index;
exports.default = _default;
},{"@emotion/memoize":"node_modules/@emotion/memoize/dist/memoize.browser.esm.js"}],"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"@babel/runtime/helpers/defineProperty":"node_modules/@babel/runtime/helpers/defineProperty.js","react":"node_modules/react/index.js","@emotion/is-prop-valid":"node_modules/@emotion/is-prop-valid/dist/is-prop-valid.browser.esm.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js","@emotion/utils":"node_modules/@emotion/utils/dist/utils.browser.esm.js","@emotion/serialize":"node_modules/@emotion/serialize/dist/serialize.browser.esm.js"}],"src/Components/StyledComponents/Spinner.js":[function(require,module,exports) {
"use strict";
...
var SpinnerContainer = (0, _styledBase.default)("div", {
  ...
  name: "18l9mlq",
  styles: "position:fixed;top:0;bottom:0;right:0;left:0;display:flex;flex-direction:row;justify-content:center;align-items:center;z-index:10;"
} : {
  name: "18l9mlq",
  styles: "position:fixed;top:0;bottom:0;right:0;left:0;display:flex;flex-direction:row;justify-content:center;align-items:center;z-index:10;",
...
function Spinner() {
  return (0, _core.jsx)(SpinnerContainer, null, (0, _core.jsx)(LoadingSpinner, {
...
(function () {
  ...
  reactHotLoader.register(SpinnerContainer, "SpinnerContainer", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/Spinner.js");
  reactHotLoader.register(LoadingSpinner, "LoadingSpinner", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/Spinner.js");
  reactHotLoader.register(Spinner, "Spinner", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/Spinner.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/Spinner.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/ErrorBoundary.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","@babel/runtime/helpers/possibleConstructorReturn":"node_modules/@babel/runtime/helpers/possibleConstructorReturn.js","@babel/runtime/helpers/getPrototypeOf":"node_modules/@babel/runtime/helpers/getPrototypeOf.js","@babel/runtime/helpers/inherits":"node_modules/@babel/runtime/helpers/inherits.js","react":"node_modules/react/index.js","./StyledComponents/Spinner":"src/Components/StyledComponents/Spinner.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/Forms/FormRouter.js":[function(require,module,exports) {
"use strict";
...
var Banner = (0, _react.lazy)(function () {
  return require("_bundle_loader")(require.resolve("../StyledComponents/Banner"));
});
...
var GivingSuccessMessage = (0, _react.lazy)(function () {
  return require("_bundle_loader")(require.resolve("../SuccessPages/GivingSuccessMessage"));
});
  ...
  switch (formType) {
    ...
    case "giving":
      return (0, _core.jsx)(_GivingFormProvider.default, null, (0, _core.jsx)(_react.Suspense, {
        ...
        expired: true
      }) : (0, _core.jsx)(_react.default.Fragment, null, (0, _core.jsx)(_ErrorBoundary.default, null, (0, _core.jsx)(GivingForm, (0, _extends2.default)({}, props, formConfig, {
        submitted: submitted,
        formBackgroundColor: formBackgroundColor,
        formBorderColor: formBorderColor,
        formBorderRadius: formBorderRadius,
    ...
    case "signup":
      return (0, _core.jsx)(_SignUpFormProvider.default, null, (0, _core.jsx)(_react.Suspense, {
        ...
        expired: true
      }) : (0, _core.jsx)(_react.default.Fragment, null, (0, _core.jsx)(_ErrorBoundary.default, null, (0, _core.jsx)(SignUpForm, (0, _extends2.default)({}, props, formConfig, {
        formBackgroundColor: formBackgroundColor,
        formBorderColor: formBorderColor,
        formBorderRadius: formBorderRadius,
        formBorderWidth: formBorderWidth,
...
__signature__(FormRouter, "useContext{{\n\t\tformConfig,\n\t\tsubmitted,\n\t\tconfirmed,\n\t\tgetCssConfig,\n\t\texpired,\n\t}}");
...
(function () {
  ...
  reactHotLoader.register(Banner, "Banner", "/Users/wehand/Code/react-form-drupal/src/Components/Forms/FormRouter.js");
...
(function () {
  ...
  reactHotLoader.register(Wrapper, "Wrapper", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/Wrapper.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/Wrapper.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/App.js":[function(require,module,exports) {
"use strict";
...
var _Wrapper = _interopRequireDefault(require("./StyledComponents/Wrapper"));
...
var handleUnload = function handleUnload(e) {
  var returnValue = "Are you sure you want to go back?\n You may lose all your changes to this page.";
...
function (_Component) {
  ...
  (0, _createClass2.default)(App, [{
    ...
    value: function render() {
      ...
      return (0, _core.jsx)(_reactAriaLive.LiveAnnouncer, null, (0, _core.jsx)(_Wrapper.default, {
        className: "wrapper"
      }, status !== "loaded" ? (0, _core.jsx)(_Spinner.default, null) : (0, _core.jsx)(_FormRouter.default, null)));
    }
  }, {
    key: "__reactstandin__regenerateByEval",
    // @ts-ignore
...
(function () {
  ...
  reactHotLoader.register(handleUnload, "handleUnload", "/Users/wehand/Code/react-form-drupal/src/Components/App.js");
  reactHotLoader.register(App, "App", "/Users/wehand/Code/react-form-drupal/src/Components/App.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/App.js");
})();
...
},{"@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","@babel/runtime/helpers/possibleConstructorReturn":"node_modules/@babel/runtime/helpers/possibleConstructorReturn.js","@babel/runtime/helpers/getPrototypeOf":"node_modules/@babel/runtime/helpers/getPrototypeOf.js","@babel/runtime/helpers/inherits":"node_modules/@babel/runtime/helpers/inherits.js","react":"node_modules/react/index.js","./Contexts/FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","./Forms/FormRouter":"src/Components/Forms/FormRouter.js","react-aria-live":"node_modules/react-aria-live/es/index.js","./StyledComponents/Wrapper":"src/Components/StyledComponents/Wrapper.js","./StyledComponents/Spinner":"src/Components/StyledComponents/Spinner.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var _FormConfigProvider = _interopRequireDefault(require("./Components/Contexts/FormConfigProvider"));
...
(function () {
  ...
  reactHotLoader.register(clubGivingRootEntry, "clubGivingRootEntry", "/Users/wehand/Code/react-form-drupal/src/index.js");
  reactHotLoader.register(givingRootEntry, "givingRootEntry", "/Users/wehand/Code/react-form-drupal/src/index.js");
  reactHotLoader.register(signupRootEntry, "signupRootEntry", "/Users/wehand/Code/react-form-drupal/src/index.js");
  reactHotLoader.register(productRootEntry, "productRootEntry", "/Users/wehand/Code/react-form-drupal/src/index.js");
})();
...
},{"./vendors":"src/vendors.js","core-js/stable":"node_modules/core-js/stable/index.js","./helpers/remove-polyfill":"src/helpers/remove-polyfill.js","./helpers/fetch-helpers":"src/helpers/fetch-helpers.js","react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./Components/App":"src/Components/App.js","./Components/Contexts/FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"node_modules/@babel/runtime/helpers/esm/extends.js":[function(require,module,exports) {
"use strict";
...
var queryType = _propTypes.default.oneOfType([_propTypes.default.string, _propTypes.default.object, _propTypes.default.arrayOf(_propTypes.default.object.isRequired)]);
/**
...
function (_React$Component) {
  ...
  function Media(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "queries", []);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "getMatches", function () {
      var result = _this.queries.reduce(function (acc, _ref) {
        var _extends2;

        var name = _ref.name,
            mqListener = _ref.mqListener;
        return (0, _extends4.default)({}, acc, (_extends2 = {}, _extends2[name] = mqListener.matches, _extends2));
      }, {}); // return result;
    ...
    !(!(!props.query && !props.queries) || props.query && props.queries) ? "development" !== "production" ? (0, _invariant.default)(false, '<Media> must be supplied with either "query" or "queries"') : (0, _invariant.default)(false) : void 0;
    !(props.defaultMatches === undefined || !props.query || typeof props.defaultMatches === "boolean") ? "development" !== "production" ? (0, _invariant.default)(false, "<Media> when query is set, defaultMatches must be a boolean, received " + typeof props.defaultMatches) : (0, _invariant.default)(false) : void 0;
    !(props.defaultMatches === undefined || !props.queries || typeof props.defaultMatches === "object") ? "development" !== "production" ? (0, _invariant.default)(false, "<Media> when queries is set, defaultMatches must be a object of booleans, received " + typeof props.defaultMatches) : (0, _invariant.default)(false) : void 0;
    ...
    if (typeof window !== "object") {
      ...
      /* if (props.queries) */
          ...
          matches = Object.keys(_this.props.queries).reduce(function (acc, key) {
            ...
            return (0, _extends4.default)({}, acc, (_extends3 = {}, _extends3[key] = true, _extends3));
          }, {});
        }
  ...
  _proto.initialize = function initialize() {
    ...
    this.queries = Object.keys(queries).map(function (name) {
      ...
      var qs = typeof query !== "string" ? (0, _json2mq.default)(query) : query;
  ...
  _proto.render = function render() {
    ...
    _react.default.Children.only(children) && typeof _react.default.Children.only(children).type === "string" ? _react.default.Children.only(children) : _react.default.cloneElement(_react.default.Children.only(children), {
      matches: matches
    }) : null : null : null;
  };
...
(0, _defineProperty2.default)(Media, "propTypes", {
  defaultMatches: _propTypes.default.oneOfType([_propTypes.default.bool, _propTypes.default.objectOf(_propTypes.default.bool)]),
  query: queryType,
...
var _default = Media;
exports.default = _default;
},{"@babel/runtime/helpers/esm/extends":"node_modules/@babel/runtime/helpers/esm/extends.js","@babel/runtime/helpers/esm/inheritsLoose":"node_modules/@babel/runtime/helpers/esm/inheritsLoose.js","@babel/runtime/helpers/esm/assertThisInitialized":"node_modules/@babel/runtime/helpers/esm/assertThisInitialized.js","@babel/runtime/helpers/esm/defineProperty":"node_modules/@babel/runtime/helpers/esm/defineProperty.js","react":"node_modules/react/index.js","prop-types":"node_modules/prop-types/index.js","invariant":"node_modules/invariant/browser.js","json2mq":"node_modules/json2mq/index.js"}],"src/Components/StyledComponents/FormWrapper.js":[function(require,module,exports) {
"use strict";
...
var FormWrapper = function FormWrapper(_ref) {
  ...
  return (0, _core.jsx)(_reactTransitionGroup.Transition, {
    ...
    return (0, _core.jsx)(Wrapper, {
      style: _objectSpread({}, style, {}, defaultStyle, {}, transitionStyles[state]),
      formBackgroundColor: formBackgroundColor,
      formBorderColor: formBorderColor,
      formBorderRadius: formBorderRadius,
      formBorderWidth: formBorderWidth,
...
(function () {
  ...
  reactHotLoader.register(duration, "duration", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/FormWrapper.js");
  reactHotLoader.register(defaultStyle, "defaultStyle", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/FormWrapper.js");
  reactHotLoader.register(transitionStyles, "transitionStyles", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/FormWrapper.js");
  reactHotLoader.register(Wrapper, "Wrapper", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/FormWrapper.js");
  reactHotLoader.register(FormWrapper, "FormWrapper", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/FormWrapper.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/StyledComponents/FormWrapper.js");
})();
...
},{"@babel/runtime/helpers/defineProperty":"node_modules/@babel/runtime/helpers/defineProperty.js","@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js","react-transition-group":"node_modules/react-transition-group/esm/index.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/Components/FormComponents/StyledComponents/Divider.js":[function(require,module,exports) {
"use strict";
...
}, " flex:0 0 18px;" + ("development" === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/StyledComponents/FieldSet.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  reactHotLoader.register(FieldSet, "FieldSet", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/FieldSet.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/FieldSet.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/StyledComponents/FormRow.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  reactHotLoader.register(FormRow, "FormRow", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/FormRow.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/FormRow.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/Animations/designations.css":[function(require,module,exports) {
var __signature__ = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default.signature : function (a) {
  return a;
};
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/Components/FormComponents/StyledComponents/FormHeader.js":[function(require,module,exports) {
"use strict";
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/StyledComponents/Designation.js":[function(require,module,exports) {
"use strict";
...
var DesignationOverlay = (0, _styledBase.default)("div", {
  ...
  name: "2vw2af",
  styles: "position:fixed;top:0;bottom:0;left:0;right:0;z-index:1;background:rgba(0,0,0,0.19);"
} : {
  name: "2vw2af",
  styles: "position:fixed;top:0;bottom:0;left:0;right:0;z-index:1;background:rgba(0,0,0,0.19);",
...
var DesignationContainer = (0, _styledBase.default)("div", {
  ...
  name: "76s2dk",
  styles: "position:relative;z-index:1;@media screen and (max-width:716px){margin-top:10px;}"
} : {
  name: "76s2dk",
  styles: "position:relative;z-index:1;@media screen and (max-width:716px){margin-top:10px;}",
...
})("display:flex;opacity:", function (props) {
  return props.selected || props.hover ? "1" : "0";
}, ";color:", function (props) {
  return !props.selected ? "#ededed" : "#fff";
}, ";justify-self:flex-end;padding:2px;margin-left:10px;font-size:24px;border-radius:50%;transition:opacity 200ms ease-in-out;" + ("development" === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
(function () {
  ...
  reactHotLoader.register(DesignationOverlay, "DesignationOverlay", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/Designation.js");
  ...
  reactHotLoader.register(DesignationCheck, "DesignationCheck", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/Designation.js");
  ...
  reactHotLoader.register(DesignationList, "DesignationList", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/Designation.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/SVG/DropArrow.js":[function(require,module,exports) {
"use strict";
...
var DropArrow = function DropArrow(_ref) {
  ...
  }, (0, _core.jsx)("title", null, "baseline-arrow_drop_down-24px copy"), (0, _core.jsx)("g", {
    id: "Welcome",
    stroke: "none",
    strokeWidth: "1",
    fill: "none",
...
(function () {
  ...
  reactHotLoader.register(DropArrow, "DropArrow", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/SVG/DropArrow.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/SVG/DropArrow.js");
})();
...
},{"react":"node_modules/react/index.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/SVG/CheckMark.js":[function(require,module,exports) {
"use strict";
...
var CheckMark = function CheckMark(_ref) {
  ...
  return (0, _core.jsx)("svg", {
    ...
    version: "1.1",
    xmlns: "http://www.w3.org/2000/svg"
  }, (0, _core.jsx)("title", null, "baseline-check_circle-24px"), (0, _core.jsx)("g", {
    id: "Welcome",
    stroke: "none",
    strokeWidth: "1",
    fill: "none",
...
(function () {
  ...
  reactHotLoader.register(CheckMark, "CheckMark", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/SVG/CheckMark.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/SVG/CheckMark.js");
})();
...
},{"react":"node_modules/react/index.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/SVG/CloseBtn.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  reactHotLoader.register(CloseBtn, "CloseBtn", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/SVG/CloseBtn.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/SVG/CloseBtn.js");
})();
...
},{"react":"node_modules/react/index.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"node_modules/process/browser.js":[function(require,module,exports) {
...
},{"raf/polyfill":"node_modules/raf/polyfill.js"}],"src/Components/FormComponents/Blocks/DesignationBlock.js":[function(require,module,exports) {
"use strict";
...
var DesignationBlock = function DesignationBlock(_ref) {
  ...
  var _useState9 = (0, _react.useState)("The Standard Designation for Single Gifts is " + designations[designatedIndex].title),
  ...
  (0, _react.useEffect)(function () {
    if (!initialized) {
      var initialDesignation = preset ? designations.findIndex(function (_ref2) {
  ...
  return (0, _core.jsx)(_react.default.Fragment, null, (0, _core.jsx)(_reactAriaLive.LiveMessage, {
    message: a11yMessage,
    "aria-live": "polite",
  ...
  })), (0, _core.jsx)(_Designation.DesignationContainer, {
  ...
  }, "Designate Gift (optional)"), (0, _core.jsx)(_Designation.Designation, {
    ...
    alt: "The ministry of ".concat(designations[designatedIndex].title)
  })), (0, _core.jsx)("div", {
    ...
    currentColor: "#333"
  })), (0, _core.jsx)(_Designation.DesignationList, {
    ref: listRef,
    role: "listbox",
    id: "listbox",
    "aria-labelledby": "listbox-label",
    "aria-activedescendant": "designation-".concat(designatedIndex),
    tabIndex: isOpen ? "0" : "-1",
    onKeyUp: handleKeyUp
    ...
    return (0, _core.jsx)(_Designation.Designation, {
      ...
      className: "designation ".concat(idx === designatedIndex ? "selected" : ""),
    ...
    })), (0, _core.jsx)(_Designation.DesignationCheck, {
...
},{"@babel/runtime/helpers/slicedToArray":"node_modules/@babel/runtime/helpers/slicedToArray.js","react":"node_modules/react/index.js","../../Contexts/GivingFormProvider":"src/Components/Contexts/GivingFormProvider.js","react-transition-group":"node_modules/react-transition-group/esm/index.js","react-aria-live":"node_modules/react-aria-live/es/index.js","../Animations/designations.css":"src/Components/FormComponents/Animations/designations.css","../StyledComponents/FormHeader":"src/Components/FormComponents/StyledComponents/FormHeader.js","../StyledComponents/Designation":"src/Components/FormComponents/StyledComponents/Designation.js","../SVG/DropArrow":"src/Components/FormComponents/SVG/DropArrow.js","../SVG/CheckMark":"src/Components/FormComponents/SVG/CheckMark.js","../SVG/CloseBtn":"src/Components/FormComponents/SVG/CloseBtn.js","../../../helpers/scrollToPoint":"src/helpers/scrollToPoint.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/StyledComponents/FormPanel.js":[function(require,module,exports) {
"use strict";
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/StyledComponents/SubmitButtonGroup.js":[function(require,module,exports) {
"use strict";
...
}, ";cursor:pointer;display:block;border:1px solid ", function (props) {
  return props.submitBtnBorderColor;
}, ";border-radius:", function (props) {
  return props.submitBtnBorderRadius;
}, ";display:block;font-weight:600;font-size:19px;height:50px;line-height:50px;margin:20px auto;margin-bottom:10px;width:300px;box-shadow:", function (props) {
...
(function () {
  ...
  reactHotLoader.register(SubmitButtonGroup, "SubmitButtonGroup", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/SubmitButtonGroup.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/SubmitButtonGroup.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/StyledComponents/FormError.js":[function(require,module,exports) {
"use strict";
...
var FormError = (0, _styledBase.default)("div", {
  ...
  return props.color;
}, ";width:auto;font-weight:600;font-size:16px;opacity:1;overflow:hidden;max-width:100%;white-space:nowrap;left:50%;transform:translateX(-50%);bottom:calc(0% - 25px);" + ("development" === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
(function () {
  ...
  reactHotLoader.register(FormError, "FormError", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/FormError.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/FormError.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/FunctionalComponents/SubmitButton.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  reactHotLoader.register(SubmitButton, "SubmitButton", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/SubmitButton.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/SubmitButton.js");
})();
...
},{"react":"node_modules/react/index.js","../../Contexts/FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","../StyledComponents/SubmitButtonGroup":"src/Components/FormComponents/StyledComponents/SubmitButtonGroup.js","../StyledComponents/FormError":"src/Components/FormComponents/StyledComponents/FormError.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/StyledComponents/FormGroup.js":[function(require,module,exports) {
"use strict";
...
}, ";font-size:16px;font-weight:", function (props) {
  return props.labelFontWeight;
}, ";margin-bottom:0;letter-spacing:0.3px;position:absolute;opacity:", function (props) {
  return props.labelOpacity;
}, ";bottom:calc( 100% - ", function (props) {
  return props.inputHoverBoxShadow == "none" ? "4px" : "2px";
}, " );left:3px;transition:opacity 150ms ease-in-out;text-transform:", function (props) {
  return props.labelTextTransform;
}, ";}label span{position:absolute;top:-1px;color:", function (props) {
  return props.labelColor;
}, ";}&:hover label,&:active label,&:focus label{opacity:1;}input,select,textarea{box-sizing:border-box;color:", function (props) {
  return props.inputColor;
}, ";font-size:19px;font-weight:600;height:45px;display:block;width:100%;margin-top:5px;padding:0 10px;background:none;background-color:", function (props) {
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/StyledComponents/InputError.js":[function(require,module,exports) {
"use strict";
...
}, ";width:calc(100% - 6px);line-height:unset;left:3px;bottom:auto;top:50px;font-weight:600;font-size:15px;opacity:1;overflow:hidden;white-space:nowrap;" + ("development" === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
(function () {
  ...
  reactHotLoader.register(InputError, "InputError", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/InputError.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/InputError.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/FunctionalComponents/SelectGroup.js":[function(require,module,exports) {
"use strict";
...
var SelectGroup = function SelectGroup(_ref) {
  ...
  var _getCssConfig = getCssConfig("input"),
      ...
      inputHoverBorderWidth = _getCssConfig$inputHo2 === void 0 ? "1px" : _getCssConfig$inputHo2,
      _getCssConfig$inputHo3 = _getCssConfig.inputHoverBoxShadow,
      inputHoverBoxShadow = _getCssConfig$inputHo3 === void 0 ? "inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 8px #747474" : _getCssConfig$inputHo3,
      _getCssConfig$inputHo4 = _getCssConfig.inputHoverBackgroundColor,
      inputHoverBackgroundColor = _getCssConfig$inputHo4 === void 0 ? "#fff" : _getCssConfig$inputHo4,
      ...
      inputErrorBorderWidth = _getCssConfig$inputEr2 === void 0 ? "1px" : _getCssConfig$inputEr2,
...
(function () {
  ...
  reactHotLoader.register(SelectGroup, "SelectGroup", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/SelectGroup.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/SelectGroup.js");
})();
...
},{"react":"node_modules/react/index.js","../StyledComponents/FormGroup":"src/Components/FormComponents/StyledComponents/FormGroup.js","../StyledComponents/InputError":"src/Components/FormComponents/StyledComponents/InputError.js","../../Contexts/FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/FunctionalComponents/InputGroup.js":[function(require,module,exports) {
"use strict";
...
__signature__(InputGroup, "useContext{{ getCssConfig, allowInputPlaceholders }}");
...
(function () {
  ...
  reactHotLoader.register(InputGroup, "InputGroup", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/InputGroup.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/InputGroup.js");
})();
...
},{"react":"node_modules/react/index.js","../StyledComponents/FormGroup":"src/Components/FormComponents/StyledComponents/FormGroup.js","../StyledComponents/InputError":"src/Components/FormComponents/StyledComponents/InputError.js","../../Contexts/FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/Blocks/NameBlock.js":[function(require,module,exports) {
"use strict";
...
var _SelectGroup = _interopRequireDefault(require("../FunctionalComponents/SelectGroup"));

var _InputGroup = _interopRequireDefault(require("../FunctionalComponents/InputGroup"));
  ...
  if (!getMiddleName && !getSuffix) {
    ...
    return (0, _core.jsx)(_FieldSet.default, null, (0, _core.jsx)("legend", null, "".concat(type, " Block")), (0, _core.jsx)(_FormRow.default, {
      ...
      options: [(0, _core.jsx)("option", {
        ...
        value: "",
        disabled: "disabled"
      }, "Suffix* \u25BF"), (0, _core.jsx)("option", {
        key: "suff-1",
        value: "Jr"
      }, "Jr"), (0, _core.jsx)("option", {
        key: "suff-2",
        value: "Sr"
      }, "Sr"), (0, _core.jsx)("option", {
        key: "suff-3",
        value: "III"
      }, "III"), (0, _core.jsx)("option", {
        key: "suff-4",
        value: "IV"
      }, "IV"), (0, _core.jsx)("option", {
        key: "suff-5",
        value: "Esq"
      }, "Esq")]
    })), getSpouseInfo && (0, _core.jsx)(SpouseInput, {
...
(function () {
  ...
  reactHotLoader.register(TitleDropdown, "TitleDropdown", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/NameBlock.js");
  reactHotLoader.register(NameInput, "NameInput", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/NameBlock.js");
  reactHotLoader.register(SpouseInput, "SpouseInput", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/NameBlock.js");
  reactHotLoader.register(NameBlock, "NameBlock", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/NameBlock.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/NameBlock.js");
})();
...
},{"react":"node_modules/react/index.js","../StyledComponents/FormRow":"src/Components/FormComponents/StyledComponents/FormRow.js","../StyledComponents/FieldSet":"src/Components/FormComponents/StyledComponents/FieldSet.js","../FunctionalComponents/SelectGroup":"src/Components/FormComponents/FunctionalComponents/SelectGroup.js","../FunctionalComponents/InputGroup":"src/Components/FormComponents/FunctionalComponents/InputGroup.js","../../Contexts/FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/Animations/country-change.css":[function(require,module,exports) {
var __signature__ = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default.signature : function (a) {
  return a;
};
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/config/dropdowns.json":[function(require,module,exports) {
var __signature__ = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default.signature : function (a) {
  return a;
};
...
},{}],"src/Components/FormComponents/FunctionalComponents/StateOptions.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  reactHotLoader.register(StateOptions, "StateOptions", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/StateOptions.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/StateOptions.js");
})();
...
},{"react":"node_modules/react/index.js","../../../config/dropdowns.json":"src/config/dropdowns.json","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/Blocks/AddressBlock.js":[function(require,module,exports) {
"use strict";
...
var _StateOptions = _interopRequireDefault(require("../FunctionalComponents/StateOptions"));
...
var AddressBlock = function AddressBlock(_ref) {
  ...
  return (0, _core.jsx)(_FieldSet.default, {
    ...
    handleInputChange: handleInputChange,
    handleBlur: handleBlur
  }, (0, _defineProperty2.default)(_EmotionJSX, "required", fields.Country == "United States"), (0, _defineProperty2.default)(_EmotionJSX, "disabled", submitting || validating), (0, _defineProperty2.default)(_EmotionJSX, "options", [(0, _core.jsx)("option", {
    key: "state-base-0",
    value: "",
    disabled: "disabled",
    dangerouslySetInnerHTML: {
    ...
    return matches ? (0, _core.jsx)(_StateOptions.default, {
      allowInternational: allowInternational,
      displayIndex: 0
  ...
  })]), _EmotionJSX))), (0, _core.jsx)(_reactTransitionGroup.CSSTransition, {
    in: fields.Country == "United States",
    timeout: {
      appear: 400,
      enter: 400,
    ...
    disabled: submitting,
    inputMode: "email"
  }), getPhone && (0, _core.jsx)(_reactTransitionGroup.CSSTransition, {
    in: fields.Country == "United States",
    timeout: {
      appear: 400,
      enter: 400,
...
(function () {
  ...
  reactHotLoader.register(AddressBlock, "AddressBlock", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/AddressBlock.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/AddressBlock.js");
})();
...
},{"@babel/runtime/helpers/defineProperty":"node_modules/@babel/runtime/helpers/defineProperty.js","react":"node_modules/react/index.js","react-transition-group":"node_modules/react-transition-group/esm/index.js","react-media":"node_modules/react-media/esm/react-media.js","../Animations/country-change.css":"src/Components/FormComponents/Animations/country-change.css","../../Contexts/FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","../StyledComponents/FormRow":"src/Components/FormComponents/StyledComponents/FormRow.js","../StyledComponents/FieldSet":"src/Components/FormComponents/StyledComponents/FieldSet.js","../FunctionalComponents/InputGroup":"src/Components/FormComponents/FunctionalComponents/InputGroup.js","../FunctionalComponents/SelectGroup":"src/Components/FormComponents/FunctionalComponents/SelectGroup.js","../FunctionalComponents/StateOptions":"src/Components/FormComponents/FunctionalComponents/StateOptions.js","../../../config/dropdowns.json":"src/config/dropdowns.json","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/FunctionalComponents/Seals.js":[function(require,module,exports) {
"use strict";
...
var Seals = function Seals(_ref) {
  ...
  var digicertScript = document.querySelector("script[src*='seal.min.js']");
  ...
  return (0, _core.jsx)(SealsBlock, {
    id: "seals",
    style: style
  }, (0, _core.jsx)(DigiCert, null), (0, _core.jsx)("div", {
    id: "ECFA_Logo",
    className: "seals__seal"
  }, (0, _core.jsx)("a", {
    className: "seals__seal--link",
...
__signature__(Seals, "useState{[loaded, setLoaded](false)}\nuseEffect{}");
...
(function () {
  ...
  reactHotLoader.register(SealsBlock, "SealsBlock", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/Seals.js");
  reactHotLoader.register(certs, "certs", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/Seals.js");
  reactHotLoader.register(DigiCert, "DigiCert", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/Seals.js");
  reactHotLoader.register(Seals, "Seals", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/Seals.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/Seals.js");
})();
...
},{"@babel/runtime/helpers/slicedToArray":"node_modules/@babel/runtime/helpers/slicedToArray.js","@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/SVG/CBNLogo.js":[function(require,module,exports) {
"use strict";
...
var CBNLogo = function CBNLogo() {
  ...
  }, (0, _core.jsx)("title", null, "CBN Logo"), (0, _core.jsx)("g", {
    id: "Layer_2",
    "data-name": "Layer 2"
  }, (0, _core.jsx)("g", {
    id: "COAL"
...
(function () {
  ...
  reactHotLoader.register(CBNLogo, "CBNLogo", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/SVG/CBNLogo.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/SVG/CBNLogo.js");
})();
...
},{"react":"node_modules/react/index.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/Blocks/HeaderBlock.js":[function(require,module,exports) {
"use strict";
...
var Header = (0, _styledBase.default)("header", {
  target: "ezpq3p70",
  label: "Header"
})("box-sizing:border-box;width:100%;height:auto;padding:10px;margin:0;margin-bottom:35px;background:#747474;background:", function (props) {
  return props.background;
}, ";background-size:cover;background-repeat:no-repeat;background-position:center center;@media screen and (max-width:", function (props) {
  return props.formMaxWidth;
}, "){margin-bottom:0;}div.header-container{max-width:", function (props) {
  return props.formMaxWidth;
}, ";margin:0 auto;padding:30px 10px;width:100%;box-sizing:border-box;h2.header-title{font-size:36px;font-weight:bold;color:#ffffff;text-align:center;line-height:42px;margin:0;margin-block-start:0;margin-block-end:0;padding:0;}p.header-description{font-size:20px;font-weight:600;line-height:23px;color:#ffffff;text-align:center;margin:0;margin-block-start:0;margin-block-end:0;padding:0;display:flex;flex-direction:row;flex-wrap:wrap;span{padding-top:20px;font-size:20px;font-weight:600;line-height:23px;color:#ffffff;text-align:center;width:100%;}em{width:100%;padding-top:20px;font-size:18px;font-weight:600;line-height:22px;font-style:italic;}}@media screen and (max-width:649px){padding:20px 10px;}}" + ("development" === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
var Nav = (0, _styledBase.default)("nav", {
  target: "ezpq3p71",
  label: "Nav"
})("development" === "production" ? {
  name: "xekgfl",
  styles: "height:100px;width:100%;display:flex;justify-content:center;flex-direction:row;align-items:center;@media screen and (max-width:649px){height:45px;}div.nav-container{width:100%;max-width:1200px;margin:0 auto;display:flex;flex-direction:row;justify-content:space-between;align-items:center;svg{height:60px;.logo-1,.logo-2{fill:#fff;}.logo-2{fill-rule:evenodd;}@media screen and (max-width:649px){height:45px;}@media screen and (max-width:530px){margin-top:10px;.logo-1:not(.cbn-letter):not(.cbn-fire),.logo-2:not(.cbn-letter):not(.cbn-fire){display:none;}}}span{color:#ffffff;flex:1 1 135px;text-align:right;a{font-size:17px;font-weight:500;color:white;text-decoration:none;transition:color 200ms ease-in-out;}a:hover,a:active,a:focus{text-decoration:underline;color:#ddd;}@media screen and (max-width:460px){flex-grow:0;}}}"
} : {
  name: "xekgfl",
  styles: "height:100px;width:100%;display:flex;justify-content:center;flex-direction:row;align-items:center;@media screen and (max-width:649px){height:45px;}div.nav-container{width:100%;max-width:1200px;margin:0 auto;display:flex;flex-direction:row;justify-content:space-between;align-items:center;svg{height:60px;.logo-1,.logo-2{fill:#fff;}.logo-2{fill-rule:evenodd;}@media screen and (max-width:649px){height:45px;}@media screen and (max-width:530px){margin-top:10px;.logo-1:not(.cbn-letter):not(.cbn-fire),.logo-2:not(.cbn-letter):not(.cbn-fire){display:none;}}}span{color:#ffffff;flex:1 1 135px;text-align:right;a{font-size:17px;font-weight:500;color:white;text-decoration:none;transition:color 200ms ease-in-out;}a:hover,a:active,a:focus{text-decoration:underline;color:#ddd;}@media screen and (max-width:460px){flex-grow:0;}}}",
...
var HeaderBlock = function HeaderBlock(_ref) {
  ...
  }, (0, _core.jsx)(_CBNLogo.default, null), (0, _core.jsx)("span", null, "Give By Phone ", (0, _core.jsx)("a", {
    href: "tel:18007007000"
  }, "1-800-700-7000")))), (0, _core.jsx)("div", {
    className: "header-container"
  }, (0, _core.jsx)("h2", {
    className: "header-title"
  }, successTitle ? successTitle : title), (0, _core.jsx)("p", {
...
__signature__(HeaderBlock, "useContext{{ getCssConfig, getFormConfig }}\nuseMemo{{ formMaxWidth }}\nuseMemo{{ background, title, description }}");
...
(function () {
  ...
  reactHotLoader.register(Header, "Header", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/HeaderBlock.js");
  reactHotLoader.register(Nav, "Nav", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/HeaderBlock.js");
  reactHotLoader.register(HeaderBlock, "HeaderBlock", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/HeaderBlock.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/HeaderBlock.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js","../../Contexts/FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","../SVG/CBNLogo":"src/Components/FormComponents/SVG/CBNLogo.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/Blocks/FooterBlock.js":[function(require,module,exports) {
"use strict";
...
var Footer = (0, _styledBase.default)("footer", {
  target: "e3han8u0",
  label: "Footer"
})("box-sizing:border-box;background:#fff;div.container{box-sizing:border-box;color:#3b3b3b;max-width:", function (props) {
  return props.formMaxWidth;
}, ";width:100%;padding:30px 10px;margin:0 auto;.cbn-info,.footer-links{display:flex;flex-direction:row;justify-content:center;align-items:center;flex-wrap:wrap;color:#181818;font-size:15px;line-height:18px;}.cbn-info{padding:10px 0;text-align:center;.year{font-size:15px;line-height:18px;margin:0 5px;}}.footer-links{& > *{margin:2.5px;}.pipe{font-size:15px;line-height:18px;}a{color:#181818;text-decoration:none;transition:color 200ms ease-in-out;font-size:15px;line-height:18px;}a:hover,a:focus,a:active{text-decoration:underline;color:#484848;}}@media screen and (max-width:623px){background:#eceff1;}}" + ("development" === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
...
var FooterBlock = function FooterBlock() {
  ...
  return (0, _core.jsx)(Footer, {
    ...
    className: "cbn-info"
  }, "\xA9", (0, _core.jsx)("span", {
    className: "year"
  }, year), "The Christian Broadcasting Network, Inc., A Non-profit 501 (c)(3) Charitable Organization"), (0, _core.jsx)("div", {
    className: "footer-links"
  }, (0, _core.jsx)("a", {
    className: "footer-links--link",
    href: "https://www.cbn.com/"
  }, "Home"), (0, _core.jsx)("span", {
    className: "pipe"
  }, "|"), (0, _core.jsx)("a", {
    className: "footer-links--link",
    href: "http://www1.cbn.com/about"
  }, "About CBN"), (0, _core.jsx)("span", {
    className: "pipe"
  }, "|"), (0, _core.jsx)("a", {
    className: "footer-links--link",
    href: "http://www1.cbn.com/cbn-donor-privacy-policy"
  }, "Donor Privacy Notice"), (0, _core.jsx)("span", {
    className: "pipe"
  }, "|"), (0, _core.jsx)("a", {
    className: "footer-links--link",
    href: "http://www1.cbn.com/about/cbn.com-privacy-notice"
  }, "CBN.com Privacy Notice"), (0, _core.jsx)("span", {
    className: "pipe"
  }, "|"), (0, _core.jsx)("a", {
    className: "footer-links--link",
    href: "http://www1.cbn.com/terms-of-use"
  }, "Terms of Use"), (0, _core.jsx)("span", {
    className: "pipe"
  }, "|"), (0, _core.jsx)("a", {
    className: "footer-links--link",
...
__signature__(FooterBlock, "useContext{{ getCssConfig }}\nuseMemo{{ formMaxWidth }}\nuseMemo{year}");
...
(function () {
  ...
  reactHotLoader.register(Footer, "Footer", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/FooterBlock.js");
  reactHotLoader.register(FooterBlock, "FooterBlock", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/FooterBlock.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/FooterBlock.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js","../../Contexts/FormConfigProvider":"src/Components/Contexts/FormConfigProvider.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/StyledComponents/HiddenForm.js":[function(require,module,exports) {
"use strict";
...
var HiddenForm = (0, _styledBase.default)("form", {
  ...
  name: "1xr8wk5",
  styles: "height:0;width:0;visibility:hidden;opacity:0;input[type=\"submit\"]{height:0;width:0;visibility:hidden;opacity:0;}"
} : {
  name: "1xr8wk5",
  styles: "height:0;width:0;visibility:hidden;opacity:0;input[type=\"submit\"]{height:0;width:0;visibility:hidden;opacity:0;}",
...
(function () {
  ...
  reactHotLoader.register(HiddenForm, "HiddenForm", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/HiddenForm.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/HiddenForm.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/Layouts/ProductLayout.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  reactHotLoader.register(ProductLayout, "ProductLayout", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Layouts/ProductLayout.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Layouts/ProductLayout.js");
})();
...
},{"react":"node_modules/react/index.js"}],"src/Components/FormComponents/StyledComponents/ShippingTitle.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  reactHotLoader.register(ShippingTitle, "ShippingTitle", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/ShippingTitle.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/ShippingTitle.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"src/Components/FormComponents/Blocks/ShippingAddressBlock.js":[function(require,module,exports) {
"use strict";
...
var _FormPanel = _interopRequireDefault(require("../StyledComponents/FormPanel"));

var _FormRow = _interopRequireDefault(require("../StyledComponents/FormRow"));

var _ShippingTitle = _interopRequireDefault(require("../StyledComponents/ShippingTitle"));
...
function ShippingAddressBlock(_ref) {
  ...
  return (0, _core.jsx)(_FormPanel.default, {
  ...
  }, (0, _core.jsx)(_ShippingTitle.default, null, (0, _core.jsx)("hr", null), (0, _core.jsx)("h3", null, "Shipping Address"), (0, _core.jsx)("hr", null))), (0, _core.jsx)(_FormRow.default, null, (0, _core.jsx)(_InputGroup.default, {
    type: "text",
    id: "ShipToName",
    specialStyle: "",
    label: "Name",
    ...
    options: [(0, _core.jsx)("option", {
      ...
      value: ""
    }, "State* \u25BF"), (0, _core.jsx)(_reactMedia.default, {
      key: "media-query",
      query: "(max-width: 613px)"
    }, function (matches) {
      return matches ? (0, _core.jsx)(_StateOptions.default, {
...
(function () {
  ...
  reactHotLoader.register(ShippingAddressBlock, "ShippingAddressBlock", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/ShippingAddressBlock.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/ShippingAddressBlock.js");
})();
...
},{"react":"node_modules/react/index.js","react-media":"node_modules/react-media/esm/react-media.js","../FunctionalComponents/SelectGroup":"src/Components/FormComponents/FunctionalComponents/SelectGroup.js","../FunctionalComponents/InputGroup":"src/Components/FormComponents/FunctionalComponents/InputGroup.js","../StyledComponents/FormPanel":"src/Components/FormComponents/StyledComponents/FormPanel.js","../StyledComponents/FormRow":"src/Components/FormComponents/StyledComponents/FormRow.js","../StyledComponents/ShippingTitle":"src/Components/FormComponents/StyledComponents/ShippingTitle.js","../FunctionalComponents/StateOptions":"src/Components/FormComponents/FunctionalComponents/StateOptions.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/StyledComponents/CheckboxGroup.js":[function(require,module,exports) {
"use strict";
...
var CheckboxGroup = function CheckboxGroup(_ref) {
  var children = _ref.children,
      ...
      style = _ref$style === void 0 ? {} : _ref$style;
  return (0, _core.jsx)(CheckBoxControl, {
    style: style
  }, children);
};
...
(function () {
  ...
  reactHotLoader.register(CheckBoxControl, "CheckBoxControl", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/CheckboxGroup.js");
  reactHotLoader.register(CheckboxGroup, "CheckboxGroup", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/CheckboxGroup.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/CheckboxGroup.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/FunctionalComponents/Checkbox.js":[function(require,module,exports) {
"use strict";
...
var _CheckboxGroup = _interopRequireDefault(require("../StyledComponents/CheckboxGroup"));
...
function Checkbox(_ref) {
  var id = _ref.id,
      ...
      handleInputChange = _ref.handleInputChange,
      label = _ref.label;
  return (0, _core.jsx)(_CheckboxGroup.default, {
...
(function () {
  ...
  reactHotLoader.register(Checkbox, "Checkbox", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/Checkbox.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/FunctionalComponents/Checkbox.js");
})();
...
},{"react":"node_modules/react/index.js","../StyledComponents/CheckboxGroup":"src/Components/FormComponents/StyledComponents/CheckboxGroup.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/Components/FormComponents/Blocks/FormOptionsBlock.js":[function(require,module,exports) {
"use strict";
...
var _Checkbox = _interopRequireDefault(require("../FunctionalComponents/Checkbox"));
...
(function () {
  ...
  reactHotLoader.register(FormOptionsBlock, "FormOptionsBlock", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/FormOptionsBlock.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/Blocks/FormOptionsBlock.js");
})();
...
},{"react":"node_modules/react/index.js","../FunctionalComponents/Checkbox":"src/Components/FormComponents/FunctionalComponents/Checkbox.js","../StyledComponents/FormRow":"src/Components/FormComponents/StyledComponents/FormRow.js","@emotion/core":"node_modules/@emotion/core/dist/core.browser.esm.js"}],"src/helpers/form-display-values.js":[function(require,module,exports) {
"use strict";
...
var formDisplayValue = function formDisplayValue(name, value) {
  ...
  if (name === "ccNumber") {
    if (displayValue.length > 4) {
      switch (digits[0]) {
        case "3":
          firstDivision = (0, _toConsumableArray2.default)(digits.slice(0, 4));
          secondDivision = [" "].concat((0, _toConsumableArray2.default)(digits.slice(4, 10)));
          thirdDivision = digits.length > 10 ? [" "].concat((0, _toConsumableArray2.default)(digits.slice(10, 15))) : [];
          displayValue = [].concat((0, _toConsumableArray2.default)(firstDivision), (0, _toConsumableArray2.default)(secondDivision), (0, _toConsumableArray2.default)(thirdDivision)).join("");
          strippedValue = strippedValue.split("").slice(0, 15).join(""); // value will be in format of #### ###### ##### for Amex

          if (strippedValue.length == 15) {
            res = (0, _ccValidation.validateCCInput)("ccNumber", strippedValue, strippedValue);
            error = res.error;
          }
        ...
        default:
          firstDivision = (0, _toConsumableArray2.default)(digits.slice(0, 4));
          secondDivision = [" "].concat((0, _toConsumableArray2.default)(digits.slice(4, 8)));
          thirdDivision = digits.length > 8 ? [" "].concat((0, _toConsumableArray2.default)(digits.slice(8, 12))) : [];
          fourthDivision = digits.length > 12 ? [" "].concat((0, _toConsumableArray2.default)(digits.slice(12, 16))) : [];
          displayValue = [].concat((0, _toConsumableArray2.default)(firstDivision), (0, _toConsumableArray2.default)(secondDivision), (0, _toConsumableArray2.default)(thirdDivision), (0, _toConsumableArray2.default)(fourthDivision)).join("");
          strippedValue = strippedValue.split("").slice(0, 16).join(""); // value will be in format of #### #### #### #### for VI, MC, DS
    ...
    if (displayValue.length > 0) {
      firstDivision = ["( "].concat((0, _toConsumableArray2.default)(digits.slice(0, 3)), [" ) "]);
      secondDivision = [].concat((0, _toConsumableArray2.default)(digits.slice(3, 6)), [" - "]);
      thirdDivision = (0, _toConsumableArray2.default)(digits.slice(6, 10));
      displayValue = [].concat((0, _toConsumableArray2.default)(firstDivision), (0, _toConsumableArray2.default)(secondDivision), (0, _toConsumableArray2.default)(thirdDivision)).join("");
      strippedValue = strippedValue.split("").slice(0, 10).join(""); // value will be in format of ( ### ) ### - ####
    }
  }
...
(function () {
  ...
  reactHotLoader.register(formDisplayValue, "formDisplayValue", "/Users/wehand/Code/react-form-drupal/src/helpers/form-display-values.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/helpers/form-display-values.js");
})();
...
},{"@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","./cc-validation":"src/helpers/cc-validation.js"}],"src/Components/FormComponents/StyledComponents/Disclaimer.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  reactHotLoader.register(Disclaimer, "Disclaimer", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/Disclaimer.js");
  reactHotLoader.register(_default, "default", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/Disclaimer.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js"}],"src/Components/FormComponents/StyledComponents/Card.js":[function(require,module,exports) {
"use strict";
...
var CardSection = (0, _styledBase.default)("section", {
  ...
  name: "168isxd",
  styles: "background:white;margin:0 auto;padding:30px 0;width:100%;h3{font-weight:bold;font-size:22px;margin:0;padding:0 0 20px 0;text-align:center;}@media screen and (max-width:623px){background:#eceff1;}"
} : {
  name: "168isxd",
  styles: "background:white;margin:0 auto;padding:30px 0;width:100%;h3{font-weight:bold;font-size:22px;margin:0;padding:0 0 20px 0;text-align:center;}@media screen and (max-width:623px){background:#eceff1;}",
...
var CardContainer = (0, _styledBase.default)("div", {
  target: "e1lgs3s91",
  label: "CardContainer"
})("width:calc(100% - 20px);max-width:", function (props) {
  return props.maxWidth ? props.maxWidth : "1200px";
}, ";margin:0 auto;display:flex;flex-direction:row;justify-content:space-between;aligh-items:center;@media screen and (max-width:623px){flex-wrap:wrap;}" + ("development" === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
exports.CardContainer = CardContainer;
var Card = (0, _styledBase.default)("div", {
  target: "e1lgs3s92",
  label: "Card"
})("&.card{height:250px;flex:0 1 380px;display:flex;flex-direction:column;justify-content:flex-start;box-shadow:0 2px 4px 0 rgba(0,0,0,0.1);color:#3b3b3b;}&.card + div.card{margin-left:10px;}h4.card__title{font-weight:bold;font-size:22px;margin:0;padding:10px 0;text-align:center;flex:0 0 auto;background-color:#e1e5e8;}div.card__body{padding:10px;flex:1 1 auto;background-color:#eceff1;display:flex;flex-direction:column;justify-content:space-around;align-items:center;@media screen and (max-width:623px){background:#f1f4f6;}.mail-in-form,.cbn-address,.giving-links,.phone--info,.gift-info{font-size:17px;line-height:22px;text-align:center;em{font-style:italic;}@media screen and (max-width:739px){font-size:16px;a,.cbn-address--street,.cbn-address--city-state-zip{font-size:16px;}}@media screen and (max-width:623px){font-size:17px;a,.cbn-address--street,.cbn-address--city-state-zip{font-size:17px;}}}.phone{text-align:center;a{cursor:pointer;font-size:28px;color:#3b3b3b;text-decoration:none;}}}a{color:", function (props) {
  return props.linkColor;
}, ";text-decoration:", function (props) {
  return props.linkTextDecoration;
}, ";text-align:center;transition:color 200ms ease-in-out;&:hover,&:active,&:focus{text-decoration:", function (props) {
  return props.linkHoverTextDecoration;
}, ";color:", function (props) {
  return props.linkHoverColor;
}, ";}}@media screen and (max-width:623px){&.card{margin:0 auto;}&.card + div.card{margin:0 auto;margin-top:20px;}}" + ("development" === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"));
exports.Card = Card;
;
...
(function () {
  ...
  reactHotLoader.register(CardSection, "CardSection", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/Card.js");
  reactHotLoader.register(CardContainer, "CardContainer", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/Card.js");
  reactHotLoader.register(Card, "Card", "/Users/wehand/Code/react-form-drupal/src/Components/FormComponents/StyledComponents/Card.js");
})();
...
},{"@emotion/styled-base":"node_modules/@emotion/styled-base/dist/styled-base.browser.esm.js","react":"node_modules/react/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
var b=require("node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.register("css",require("node_modules/parcel-bundler/src/builtins/loaders/browser/css-loader.js"));b.load([["react.545e1cc3.js","node_modules/react/index.js"],["secure-ls.0cd04304.js","node_modules/secure-ls/dist/secure-ls.js"],["fetch.6e6c81fd.js","node_modules/whatwg-fetch/fetch.js"],["es.d5457454.js","node_modules/react-aria-live/es/index.js"],["stable.7461f3b3.js","node_modules/core-js/stable/index.js"],["react-dom.29872971.js","node_modules/react-dom/index.js"]]).then(function(){require("src/index.js");});
