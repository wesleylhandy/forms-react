...
parcelRequire = (function(modules, cache, entry, globalName) {
	...
	{
		"src/Components/FormComponents/StyledComponents/FormLine.js": [
		...
		"src/Components/FormComponents/StyledComponents/ProductSummary.js": [
			function(require, module, exports) {
				"use strict";
		...
		"src/Components/FormComponents/StyledComponents/CCButton.js": [
			function(require, module, exports) {
				"use strict";
		...
		"src/Components/Forms/PaymentForm.js": [
			function(require, module, exports) {
				...
				var _FormRow = _interopRequireDefault(
					require("../FormComponents/StyledComponents/FormRow")
				);
				...
				var _FormLine = _interopRequireDefault(
					require("../FormComponents/StyledComponents/FormLine")
				);
				...
				var _ProductSummary = _interopRequireDefault(
					require("../FormComponents/StyledComponents/ProductSummary")
				);

				var _CCButton = _interopRequireDefault(
					require("../FormComponents/StyledComponents/CCButton")
				);
				...
				var _InputGroup = _interopRequireDefault(
					require("../FormComponents/InputGroup")
				);

				var _SelectGroup = _interopRequireDefault(
					require("../FormComponents/SelectGroup")
				);
						...
						function PaymentForm() {
							...
							_this.handleMessage = function(e) {
								...
								switch (type) {
									...
									case "form error":
										var errors = (0, _toConsumableArray2.default)(
											_this.state.errors
										);
										errors["ccNumber"] =
							...
							_this.getMainURL = function() {
								var retnURL = "";
								var mainurlStr = document.querySelector("input[name='mainURL']")
									.value;
							...
							_this.renderProductSummary = function() {
								...
								var Monthlypledgeday = isMonthly
									? _this.context.fields.Monthlypledgeday
									: 2;
								var ordinalDay;
								...
								return (0, _core.jsx)(
									...
									PrimaryPledge &&
										(0, _core.jsx)(
											...
											(0, _core.jsx)(
												...
												(0, _core.jsx)("div", null, PrimaryPledge.Description),
												(0, _core.jsx)(
													"div",
													null,
													"$",
													PrimaryPledge.PledgeAmount
												)
											),
											isMonthly &&
												(0, _core.jsx)(
									...
									donations &&
										donations.map(function(donation, idx) {
											(0, _core.jsx)(
												"div",
												{
													className: "flex-row",
												...
												(0, _core.jsx)("div", null, "$", donationa.PledgeAmount)
											);
										})
								);
							};
												...
												(0, _core.jsx)(
													...
													(0, _core.jsx)(
														...
														(0, _core.jsx)(
															...
															(0, _core.jsx)(_FormLine.default, null),
															(0, _core.jsx)(
																_FormHeader.default,
																{
			...
			},
			{
				...
				"../FormComponents/StyledComponents/FormRow":
				...
				"../FormComponents/StyledComponents/FormLine":
					"src/Components/FormComponents/StyledComponents/FormLine.js",
				"../FormComponents/StyledComponents/FormHeader":
					"src/Components/FormComponents/StyledComponents/FormHeader.js",
				"../FormComponents/StyledComponents/ProductSummary":
					"src/Components/FormComponents/StyledComponents/ProductSummary.js",
				"../FormComponents/StyledComponents/CCButton":
					"src/Components/FormComponents/StyledComponents/CCButton.js",
				...
				"../FormComponents/InputGroup":
					"src/Components/FormComponents/InputGroup.js",
				"../FormComponents/SelectGroup":
					"src/Components/FormComponents/SelectGroup.js",
